...
export default function WatchPage() {
  ...
  const fetchComment = useCallback(async () => {
    let result = null;
    if (mediaType === "movie") {
      result = await getCommentOfMovie(id);
    }
    if (mediaType === "tv") {
  ...
  return (
    <div className="stream">
      <div className="player">
        <iframe
          src={urlGenerator.getStreamUrl(mediaType, id, episode, season)}
          frameBorder="0"
          title={id}
          allowFullScreen
        ></iframe>
      ...
      {data && (
        <div className="info container">
          ...
          <div className="comment">
            ...
            {user && isComment && (
              <div className="comment__done">Thank you for your comment!</div>
            )}
            {!user && (
              <div className="comment__no-login">
